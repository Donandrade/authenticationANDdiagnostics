...
def run_primer3_epcr(input_file, output_file, output_file2):
    ...
    file = open(arquivo_alinhamento, 'r').readlines()
...
#            print(i.strip())
    ...
    def generate_primer3_input(output_file, sequence_id, sequence_template):
        with open(output_file, "a") as f:
            ...
            f.write("PRIMER_PRODUCT_SIZE_RANGE=100-200\n")
...
#            print(k, v)
        ...
        if __name__ == "__main__":
            ...
            comando_epcr = "e-PCR input_ePCR.tsv ../GCF_003713225.1_Cara_1.0_genomic.fna M=400 N=3 T=3 G=3 U=+ O=primerBlast.txt"
